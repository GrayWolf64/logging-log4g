concommand.Add("Log4g_CoreTest_LoggerConfigHierarchy", function()
    ...
    Log4g.Core.Logger.Create("foo", ctx, Log4g.Level.GetLevel("ALL"))
    Log4g.Core.Logger.Create("foo.bar", ctx, Log4g.Level.GetLevel("ALL"))
    Log4g.Core.Logger.Create("foo.bar.quiz", ctx, Log4g.Level.GetLevel("ALL"))
    Log4g.Core.Logger.Create("foo.bar.quiz.void", ctx, Log4g.Level.GetLevel("INFO"))
