...
concommand.Add("Log4g_MMC", function()
    ...
    local RowE = CreateSpecialRow(SummarySheet, "Server", "Networked Entity (edict) Count")
    ...
    PanelTimedFunc(SummarySheet, UpdateInterval, function()
        ...
        net.Receive("Log4g_CLRcv_SVSummaryData", function()
            ...
            RowD:SetValue(tostring(tostring(net.ReadUInt(14))))
            RowE:SetValue(tostring(tostring(net.ReadUInt(13))))
        end)
    end)
end)