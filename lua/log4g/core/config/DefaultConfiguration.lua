...
local CreateConsoleAppender, CreatePatternLayout = Log4g.Core.Appender.ConsoleAppender.createConsoleAppender, Log4g.GetPkgClsFuncs("log4g-core", "PatternLayout").createDefaultLayout
