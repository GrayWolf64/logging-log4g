...
local DefaultName = CreateConVar("LOG4G_CONFIGURATION_DEFAULT_NAME", "default", FCVAR_NOTIFY):GetString()
local DefaultLevel = CreateConVar("LOG4G_CONFIGURATION_DEFAULT_LEVEL", "DEBUG", FCVAR_NOTIFY):GetString()
